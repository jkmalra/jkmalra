...
<h3 align="left">Backend & Cloud Engineer building practical systems and deploying real-world products.</h3>
...
- Building **Loopzy** — an AI-powered habit tracker with FastAPI backend  
- Engineering backend + cloud-based systems  
- Experimenting with tools around **AI governance & compliance** (future niche)
